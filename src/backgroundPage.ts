...
browser.runtime.onMessage.addListener(
  async (
    ...
    console.log(`Message received from ${sender.url} for action ${r.action}`, r.payload)
    try {
      let collection
      switch (r.action) {
        ...
        case 'saveLink':
          ...
          browser.runtime.sendMessage(createBrowserRuntimeMessage('newLink', { collection }))
          break
        case 'removeLink':
          collection = await removeFromCollection(r.payload.linkHash, r.payload.collection)
