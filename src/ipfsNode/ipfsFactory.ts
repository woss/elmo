...
export async function startMultipleIpfsNodes(amount: number): Promise<IIPFSInstance[]> {
  console.error('startMultipleIpfsNodes is not fully supported, use at your own risk')
